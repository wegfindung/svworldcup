...
CREATE TABLE IF NOT EXISTS participants (
    ...
    browser_locale TEXT NOT NULL DEFAULT 'en' CONSTRAINT participants_browser_locale_chk CHECK (browser_locale IN ('en', 'es', 'de', 'fr', 'pt', 'ru', 'zh')),
...
CREATE TABLE IF NOT EXISTS email_campaign_recipients (
    ...
    browser_locale TEXT CONSTRAINT email_campaign_recipients_browser_locale_chk CHECK (browser_locale IN ('en', 'es', 'de', 'fr', 'pt', 'ru', 'zh')),
