...
async function loadTablesPayload(): Promise<TablesPayload> {
  ...
  const results = [rookieResult, veteranResult, nationResult, fixtureResult]
  ...
  return {
    ...
    fixtureLookup: fixtureResult.status === 'fulfilled' ? new Map(fixtureResult.value.items.map((fixture) => [fixture.fixtureId, fixture])) : new Map(),
  }
}
