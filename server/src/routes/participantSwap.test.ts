...
async function setup() {
  ...
  app.use('/api/participant', createParticipantRouter(sessions, squads, registrations, audit, new MemoryParticipantRiskRepository()))
  ...
  return { app, audit, clock, getSwaps, postSwap }
}
