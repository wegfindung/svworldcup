...
import { createConfigRepository, createRegistrationRepository } from './services/repos.js'
...
export function createApp() {
  ...
  app.use('/api/public', createPublicRouter({ registrationRepository, configRepository }))
  app.use('/api/auth', createAuthRouter(registrationRepository))
  app.use('/api/admin', createAdminRouter(registrationRepository, configRepository))
