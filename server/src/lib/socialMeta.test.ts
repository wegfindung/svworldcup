...
<html lang="en">
  <head>
    ...
    <meta property="og:url" content="https://stale.example.com/" />
    <meta property="og:title" content="old" />
    <meta property="og:description" content="old" />
    <meta property="og:image" content="https://stale.example.com/brand/og-image.jpg" />
    <meta property="og:image:alt" content="old" />
    <meta name="twitter:title" content="old" />
    <meta name="twitter:description" content="old" />
    <meta name="twitter:image" content="https://stale.example.com/brand/og-image.jpg" />
...
describe('renderIndexSocialMeta', () => {
  it('uses the current request origin for home preview image URLs', () => {
    ...
    expect(html).not.toContain('https://stale.example.com/brand/og-image.jpg')
  })
})
