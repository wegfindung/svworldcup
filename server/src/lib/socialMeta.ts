...
const homeSocialCopyByLocale: Record<SupportedLocale, HomeSocialCopy> = {
  en: {
    ...
    imageAlt: 'The Grant Tournament social preview image',
  },
  es: {
    htmlLang: 'es',
    ogLocale: 'es_ES',
    ...
    imageAlt: 'Imagen de vista previa social de The Grant Tournament',
  },
  it: {
    htmlLang: 'it',
    ogLocale: 'it_IT',
    ...
    imageAlt: 'Immagine di anteprima social di The Grant Tournament',
  },
  de: {
    htmlLang: 'de',
    ogLocale: 'de_DE',
    ...
    imageAlt: 'Social-Preview-Bild von The Grant Tournament',
  },
  fr: {
    htmlLang: 'fr',
    ogLocale: 'fr_FR',
    ...
    imageAlt: 'Image de partage social de The Grant Tournament',
  },
  pt: {
    htmlLang: 'pt',
    ogLocale: 'pt_PT',
    ...
    imageAlt: 'Imagem de pre-visualizacao social de The Grant Tournament',
  },
  ru: {
    htmlLang: 'ru',
    ogLocale: 'ru_RU',
    ...
    imageAlt: 'Социальное изображение предпросмотра The Grant Tournament',
  },
  zh: {
    htmlLang: 'zh',
    ogLocale: 'zh_CN',
    ...
    imageAlt: 'The Grant Tournament 社交分享预览图',
  },
  ja: {
    htmlLang: 'ja',
    ogLocale: 'ja_JP',
    ...
    imageAlt: 'The Grant Tournament のソーシャル共有プレビュー画像',
  },
}
